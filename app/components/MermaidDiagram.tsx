            ...
            if (ref.current) {
                try {
                    ...
                    mermaid.initialize({
                        ...
                        theme: "default",
                        securityLevel: "loose",
                        // Force diagrams to not exceed container width
                        flowchart: { useMaxWidth: true, htmlLabels: true, curve: 'basis' },
                        sequence: { useMaxWidth: true, showSequenceNumbers: false },
                        gantt: { useMaxWidth: true },
                        journey: { useMaxWidth: true },
                        pie: { useMaxWidth: true },
                        maxTextSize: 50000, // Prevent cutoff for large diagrams
    ...
    return (
        <>
            ...
            <div className="relative group w-full flex justify-center">
                <div
                    className="mermaid my-4 p-4 bg-white/50 dark:bg-black/20 rounded-lg overflow-x-auto flex justify-center w-full max-w-full"
                    ref={ref}
                >
                    {chart}
                </div>
