...
export default function Hero() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-white">
            ...
            <div className="container mx-auto relative z-10 px-4 md:px-6 grid lg:grid-cols-2 gap-12 items-center">
                {/* Left: Text Content */}
                <motion.div
                    ...
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 leading-[1.1]">
                        ...
                        <span className="relative">
                            ...
                            <motion.span
                                ...
                                className="inline-block w-[3px] h-[0.8em] bg-indigo-600 ml-1 align-baseline"
                            />
                        </span>
                    </h1>
                ...
                <motion.div
                    ...
                    className="relative"
                >
                    <div className="relative rounded-2xl border border-gray-200/60 bg-white/80 backdrop-blur-xl shadow-2xl shadow-indigo-100/50 overflow-hidden aspect-[4/3]">
                        {/* Mockup Header */}
                        ...
                        <div className="flex flex-col h-full bg-gray-50/50 font-sans">
                            {/* Chat Header */}
                            <div className="h-14 border-b border-gray-100 bg-white flex items-center px-6 justify-between">
