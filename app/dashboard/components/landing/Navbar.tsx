...
export default function Navbar() {
    return (
        <motion.nav
            ...
            className="fixed top-6 inset-x-0 max-w-2xl mx-auto z-50 border border-gray-200/50 bg-white/70 backdrop-blur-xl rounded-full shadow-lg shadow-gray-200/20"
        >
